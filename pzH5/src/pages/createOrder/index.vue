    ...
    <div class="header">
      ...
      <van-cell class="cell">
        <template #title>
            ...
            />
            <span class="service-name" style="margin-left: 10px;">{{ createInfo.service.serviceName }}</span>
        </template>
        <template #default>
...
onMounted (async()=>{
    ...
    console.log(createInfo)
     if (hospitalId) {
    const hospital = createInfo.hospitals.find(item => item.id == hospitalId)
    if (hospital) {
