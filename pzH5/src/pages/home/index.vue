<template>
  <div class="header">
    ...
    <van-swipe class="my-swiper" height="50px" :autoplay="3000" indicator-color="white">
      <van-swipe-item 
    ...
    <van-row justify="space-around">
        <van-col 
            ...
            class="center-img"
            span="11"
            @click="goOreder(index)">
            <van-image
                :src="item.pic_image_url"
          /></van-col>
    </van-row>
    <van-row  @click="goOrederText(item)" class="yy-list" v-for="item in homeData.hospitals"  justify="space-around">
      <van-col span="6">
        <van-image
            width="100px"
            height="90px"
